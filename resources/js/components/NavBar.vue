<template>
    <header class="fixed left-0 top-0 right-0 flex bg-primary-900 rounded-b-lg">
        ...
        <div id="nav-bar" class="flex w-full pt-4 justify-end bg-primary-900 rounded-b-lg">
            <section class="relative w-1/6">
                ...
                <div v-if="exploreIsOpen" class="absolute w-full rounded-md bg-primary-700 p-2 text-sm">
            ...
            <section class="relative w-1/6">
                ...
                <div v-if="viewIsOpen" class="absolute flex flex-wrap w-auto rounded-md bg-primary-700 text-sm">
